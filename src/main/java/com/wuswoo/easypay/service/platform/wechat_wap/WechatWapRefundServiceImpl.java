 ...
 */
public class WechatWapRefundServiceImpl extends AbstractRefundService {

    private final static Logger logger = LogManager.getLogger(WechatWapRefundServiceImpl.class);
    @Autowired
    ...
    public WechatWapRefundServiceImpl(RefundRequest refundRequest) {
        super(refundRequest);
    }
