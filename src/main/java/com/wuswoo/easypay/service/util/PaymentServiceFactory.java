...
public class PaymentServiceFactory {
    public static IEasyPaymentService getPaymentService(Integer platform) {
        return MyApplicationContext.getInstance().getBean("paymentService" + platform, IEasyPaymentService.class);
    }

    public static IRefundService getRefundService(Integer platform) {
        return MyApplicationContext.getInstance().getBean("refundService" + platform, IRefundService.class);

    }

    public static IResultQueryService getQueryService(Integer platform) {
        return MyApplicationContext.getInstance().getBean("queryService" + platform, IResultQueryService.class);
    }
