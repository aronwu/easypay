...
public interface IRefundDBService {
    ...
    public Refund insertRefund(Refund refund,  List<RefundResult> refundResults) throws
        EasyPayException;
    ...
    public void updateRefund(Refund refund, List<RefundResult> refundResults) throws EasyPayException;

    public RefundResult getRefundResultByRefundIdAndTradeNo(Long refundId, String tradeNo) throws EasyPayException;

    public boolean saveRefundResult(Refund refund, List<RefundResult> refundResults) throws EasyPayException;
    ...
    public RefundResult getRefundResultByRefundCodeAndPaltformId(String refundCode, Integer platformId);

    public List<Refund> getPendingRefund(Date startTime, Date endTime, Integer platformId, Long id, Integer limit);
